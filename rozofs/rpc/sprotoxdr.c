...
bool_t
xdr_sp_write_repair2_arg_t (XDR *xdrs, sp_write_repair2_arg_t *objp)
{
	//register int32_t *buf;
	...
	//int i;
	 ...
	 if (!xdr_uint32_t (xdrs, &objp->bsize))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->bitmap, 3,
...
bool_t
xdr_sp_b2rep_t (XDR *xdrs, sp_b2rep_t *objp)
{
	//register int32_t *buf;

	//int i;
	 if (!xdr_vector (xdrs, (char *)objp->hdr, 2,
		sizeof (uint64_t), (xdrproc_t) xdr_uint64_t))
		 return FALSE;
	 if (!xdr_uint32_t (xdrs, &objp->relative_bid))
		 return FALSE;
	return TRUE;
}

bool_t
xdr_sp_write_repair3_arg_t (XDR *xdrs, sp_write_repair3_arg_t *objp)
{
	//register int32_t *buf;
	...
	//int i;
	 ...
	 if (!xdr_uint32_t (xdrs, &objp->bsize))
		 return FALSE;
	 if (!xdr_vector (xdrs, (char *)objp->blk2repair, ROZOFS_MAX_REPAIR_BLOCKS,
		sizeof (sp_b2rep_t), (xdrproc_t) xdr_sp_b2rep_t))
		 return FALSE;
	 if (!xdr_bytes (xdrs, (char **)&objp->bins.bins_val, (u_int *) &objp->bins.bins_len, ~0))
		 return FALSE;
	return TRUE;
...
bool_t
xdr_sp_write_repair2_arg_no_bins_t (XDR *xdrs, sp_write_repair2_arg_no_bins_t *objp)
{
	//register int32_t *buf;
...
bool_t
xdr_sp_write_repair3_arg_no_bins_t (XDR *xdrs, sp_write_repair3_arg_no_bins_t *objp)
{
	//register int32_t *buf;
