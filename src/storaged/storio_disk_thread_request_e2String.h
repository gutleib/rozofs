...
/*___________________________________________________________________
   ...
   Date : Friday 2018 January 12, 10:17:21
   Command line : 
...
static inline char * storio_disk_thread_request_e2String (const storio_disk_thread_request_e x) {
  switch(x) {
    ...
    case STORIO_DISK_THREAD_READ_STDALONE        : return("READ STDALONE");
    case STORIO_DISK_THREAD_WRITE_STDALONE       : return("WRITE STDALONE");
